...
class NRed {
    class Attributes {    // TODO: Remove!
		...
		static constexpr UInt8 IsMendocino = getBit(5);
		...
		constexpr bool isMendocino() const { return (this->value & IsMendocino) != 0; }
		...
		constexpr void setMendocino() { this->value |= IsMendocino; }
    };
